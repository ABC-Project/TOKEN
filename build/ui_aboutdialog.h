...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About TOKEN", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>TOKEN</b> version", 0));
        copyrightLabel->setText(QApplication::translate("AboutDialog", "Copyright \302\251 2009-YYYY The Bitcoin developers\n"
"Copyright \302\251 2011-YYYY The Litecoin developers\n"
"Copyright \302\251 2020 The TOKEN developers", 0));
